...
export function  isLoadingUpdateSocials(){
   const loading = document.getElementById("loadingUpdateSocials")
   if(loading)
   {
    loading.classList.remove("visually-hidden")
   } 
...
export function isNotLoadingUpdateSocials()
{
    const loading = document.getElementById("loadingUpdateSocials")
    if(loading)
    {
...
export function isNotLoadingUDelete()
{
    const loading = document.getElementById("delete")
    if(loading)
    {
