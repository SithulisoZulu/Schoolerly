  ...
  getTransitionByIntent(intent, isIntermediate) {
    ...
    if (routeInfosEqual(newState.routeInfos, oldState.routeInfos)) {
      ...
      if (queryParamChangelist) {
        ...
        newTransition.queryParamsOnly = true; // SAFETY: The returned OpaqueTransition should actually be this.
  ...
  */
  ...
  doTransition(name, modelsArray = [], isIntermediate = false) {
    ...
    if (name === undefined) {
      ...
      intent = new _namedTransitionIntent.default(this, name, undefined, // SAFETY: We know this to be the case since we removed the last item if it was QPs
